...
export default function CanvasToolbar(props: CanvasToolbarProps) {
  return (
    <div className="absolute top-4 left-1/2 -translate-x-1/2 z-10 flex items-center gap-1 bg-gray-900/90 backdrop-blur border border-gray-700 rounded-xl px-2 py-1.5 shadow-xl">
